    ...
    <nav className= {`navbar navbar-expand-lg bg-${props.mode}`} >
        <div className="container-fluid">
            ...
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                {/* <a className="nav-link" href="/about" style={{color: `${props.mode}` === 'dark'?'white':'black'}}>{props.aboutText}</a>
                </li> */}

                {/* <li className="nav-item"> */}
                {/* <Link className="nav-link" to="/contact" style={{color: `${props.mode}` === 'dark'?'white':'black'}}>{props.contactUs}</Link> */}
                {/* <a className="nav-link" href="/contact" style={{color: `${props.mode}` === 'dark'?'white':'black'}}>{props.contactUs}</a>
                </li> */}
